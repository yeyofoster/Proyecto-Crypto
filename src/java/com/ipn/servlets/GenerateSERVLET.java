...
public class GenerateSERVLET extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        myKeys.writeToFile("C:/Users/yeyof/Desktop/AES-image-cipher-system/Llaves/"+name+"pubk"+user_id+rand+".txt", Base64.getEncoder().encode(myKeys.getPublicKey().getEncoded()));
        myKeys.writeToFile("C:/Users/yeyof/Desktop/AES-image-cipher-system/Llaves/"+name+"privk"+user_id+rand+".txt", Base64.getEncoder().encode(myKeys.getPrivateKey().getEncoded()));
        ...
        File pubkF= new File("C:/Users/yeyof/Desktop/AES-image-cipher-system/Llaves/"+name+"pubk"+user_id+rand+".txt");
        File privkF= new File("C:/Users/yeyof/Desktop/AES-image-cipher-system/Llaves/"+name+"privk"+user_id+rand+".txt");
